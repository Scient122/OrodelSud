...
<%
if(session.getAttribute("userBean")!=null||session.getAttribute("adminBean")!=null)
...
function control(){
	...
	if(ValidateEmail(elementi[0])&&pass(elementi[1])&&allLetter(elementi[2])&&allLetter(elementi[3])&&allLetter(elementi[4])&&allNumbers(elementi[5])&&allNumbers(elementi[6])&&telephone(elementi[7]))
