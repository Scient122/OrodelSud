...
<input type="hidden" name="titolo" value="<%=request.getParameter("nome")%>">
...
<img src="Immagini/Arrowtagliata.png"> </button> 
<br> <br> <br> <br>
...
function Avanti (button, contatore, collezione) {
	...
	$.ajax({type:'POST',
			...
			data:{
				'informazioni':json,
				'titolo':document.getElementsByName("titolo")[0].value,
				 },
